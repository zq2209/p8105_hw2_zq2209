...
The table is 1868 x 20. There are 11 routes variable and 9 other variables, which are line, station, name, station latitude / longitude, served, entry, vending, entrance type, and ADA compliance. So far, the cleaning steps are clean names, select required variables and change entry to logic variable. 
...
There are 37.70% without vending entrance.
...
mr_trash_wheel_raw = read_excel("Trash Wheel Collection Data.xlsx", sheet = "Mr. Trash Wheel", range = "A2:N535", col_names = TRUE)
...
There are 822 rows and 11 columns in this merged dataset. The dataset range from 1947 to 2015. And the variables are "year" "month" "unemplyment" "gov_gop" "sen_gop" "rep_gop" "gov_dem" "sen_dem"   "rep_dem"   "president" "close".
